...
\setstretch{1.2}
I have over a decade of professional experience as a Linux sysadmin, working in
commercial and government settings. More recently I've taken on devops roles to
deploy and manage large, complex systems.  Automation, proper processes, and
documentation ensures they're reliable, maintainable, and secure.
}
\hugeskip
\end{resumeblock}
...
\item Worked with other teams to adapt existing systems and design new ones for our hybrid Openshift/AWS environment.
\item Scripted and automated common rollout procedures to reduce errors, and improve efficiency and reporting.
\item Wrote and improved large amounts of documentation and processes to bring them to an auditable standard.
...
\item Post-mortem forensic analysis to inform our response following security incidents.
...
\resumeitem{Development}{Git (standalone, Github, Bitbucket), svn, software development methodologies, deployment best practices with CI, RPM and DEB packaging}
\hugeplusskip
