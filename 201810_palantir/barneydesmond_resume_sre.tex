...
used to solving difficult problems, and I take a rigorous and structured
approach to ensure the job is done properly. My background is in managing the
full stack for web-facing applications, but my interests are much broader and I
quickly pick up new skills as needed.
}
\hugeskip
\end{resumeblock}
